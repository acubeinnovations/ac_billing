...
<div class="row">
	...
	<fieldset>
 		...
 		<input type="hidden" value="-1" name="hd_invt_type" id="hd_invt_type" />
 		<div class="row">
	 		<div class="medium-3 columns" id= "dv-invt">
	 			<label for="ledger">Select Inventory Account</label>
		 		<?php echo populate_list_array("lstinventory", $ledgers, 'id','name', '',$disable=false);?>
	 		</div>

	 		<div class="medium-3 columns">
	 			<label for="ledger">Select Freight and Demurge</label>
		 		<?php echo populate_list_array("lstfreight", $ledgers, 'id','name', '',$disable=false);?>
	 		</div>

	 		<div class="medium-3 columns">
	 			<label for="ledger">Select Round Off</label>
		 		<?php echo populate_list_array("lstroundoff", $ledgers, 'id','name', '',$disable=false);?>
	 		</div>

	 		<div class="medium-3 columns" >
	 			<p></p>
	 			<label for="ledger"><input type="checkbox" name="chk_discount" id="chk_discount" value=1 />
	 			 Cash Discount
				</label>
		...
		<div class="row">
		 	...
		 	<div class="medium-3 columns">
		 		<label for="ledger" >No Of Copies (Prints)</label>
		 		<?php echo populate_list_array("lstcopy", $g_ARRAY_LIST_COPY, 'id','value', '',$disable=false,false,"style='width:60px;'");?>
