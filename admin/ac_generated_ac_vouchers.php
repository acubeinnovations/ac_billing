...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'ac_generated_ac_vouchers';		// page name for menu and other purpose
	...
	$page->class_list = array("class_pagination.php","class_voucher.php","class_account_settings.php","class_ledger.php","class_account.php");
    ...
    $page->module = 'generated_ac_vouchers';
